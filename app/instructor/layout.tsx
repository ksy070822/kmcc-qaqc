      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between border-b border-sidebar-border px-4">
            {!collapsed && (
              <div className="flex items-center gap-2 cursor-pointer" onClick={() => router.push("/instructor")}>
            ...
            {collapsed && (
              <Image src="/kakaot_logo1.png" alt="Komi" width={32} height={32} className="rounded-lg cursor-pointer" onClick={() => router.push("/instructor")} />
            )}
            {!collapsed && (
              <Button
                variant="ghost"
